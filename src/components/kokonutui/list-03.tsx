...
const ITEMS: ListItem[] = [
  {
    ...
    subtitle: "Reduction in BTC mining rewards",
    icon: Zap,
    iconStyle: "savings",
  ...
  },
  {
    ...
    subtitle: "SEC ruling on ETH ETF applications",
    icon: TrendingUp,
  ...
  },
  {
    ...
    subtitle: "Major token unlock event",
    icon: Lock,
    iconStyle: "debt",
              ...
              {typeof item.progress === "number" && (
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-zinc-600 dark:text-zinc-400">Likelihood</span>
